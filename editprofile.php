        ...
        <fieldset>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <input type="text" id="birthdate" class="form-control" name="birthdate" value="<?php if (!empty($birthdate)) echo $birthdate; else echo 'YYYY-MM-DD'; ?>" />
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <input type="text" id="city" class="form-control" name="city" value="<?php if (!empty($city)) echo $city; ?>" /><br />
              </div>
              </div>
              ...
              <input type="text" id="state"  class="form-control" name="state" value="<?php if (!empty($state)) echo $state; ?>" /><br />
              </div>
            </div>
          </div>
          ...
          <input type="file" id="new_picture" class="form-control" name="new_picture" />
          </div>
          </div>
          ...
          <?php if (!empty($old_picture)) {
            ...
            echo '<label>Current Picture:</label><img class="profile" src="' . MM_UPLOADPATH . $old_picture . '" alt="Profile Picture" />';
            echo '</div>';
          } ?>
          </div>
        <br>
        <input type="submit" value="Save Profile" class="btn btn-primary btn-block" name="submit" />
        </fieldset>
        <p>.</br>.</br><br><br><br></p>
  </form>
</div>
